...
class BookmarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookmark" do
    assert_difference('Bookmark.count') do
      post bookmarks_url, params: { bookmark: { tipo_id: @bookmark.tipo_id, url: @bookmark.url } }
    end
  ...
  test "should update bookmark" do
    patch bookmark_url(@bookmark), params: { bookmark: { tipo_id: @bookmark.tipo_id, url: @bookmark.url } }
